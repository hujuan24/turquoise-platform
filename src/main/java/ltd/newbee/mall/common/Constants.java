...
public class Constants {
    ...
    public final static String FILE_UPLOAD_DIC = "src/main/resources/static/images/turquoise/goods/";//上传文件的默认url前缀，根据部署设置自行修改
    ...
    public final static String ADMIN_SESSION_KEY = "adminUser";//session中adminUser的key
