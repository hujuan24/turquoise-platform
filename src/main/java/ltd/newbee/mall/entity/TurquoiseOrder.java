...
public class TurquoiseOrder {
    ...
    private List<TurquoiseOrderItem> orderItems;
    ...
    public List<TurquoiseOrderItem> getOrderItems() {
        return orderItems;
    }

    public void setOrderItems(List<TurquoiseOrderItem> orderItems) {
